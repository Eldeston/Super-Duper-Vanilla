...
// Full skylight so the mod skybox is visible (blocks use lightmap separately)
#define WORLD_CUSTOM_SKYLIGHT 1.00

// No stars
// #define WORLD_STARS

// Use vanilla fog color as the sky background (biome provides the gray color)
...
// Use vanilla fog color as the sky color (biome provides the gray background)
#define SKY_COLOR_DATA_BLOCK fogColor * WORLDn3_VANILLA_FOGCOLI

// Pass through the vanilla mod skybox, compositing it over the fog color background
// Credits: Kawwabi
#define VANILLA_SKY_PASS
