...
#define LIGHT_COL_DATA_BLOCK vec3(WORLD1_CUSTOM_LIGHTCOLR, WORLD1_CUSTOM_LIGHTCOLG, WORLD1_CUSTOM_LIGHTCOLB) * (WORLD1_CUSTOM_LIGHTCOLI * 0.00392156863)
#define SKY_COL_DATA_BLOCK vec3(WORLD1_CUSTOM_FOGCOLR, WORLD1_CUSTOM_FOGCOLG, WORLD1_CUSTOM_FOGCOLB) * (WORLD1_CUSTOM_FOGCOLI * 0.00392156863)