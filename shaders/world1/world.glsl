...
const vec3 endLightCol = vec3(LIGHT1_CR, LIGHT1_CG, LIGHT1_CB) * (LIGHT1_CI * 0.00392156863);
...
const vec3 endSkyCol = vec3(SKY1_CR, SKY1_CG, SKY1_CB) * (SKY1_CI * 0.00392156863);

// Holds the data on how the light will change according to multiple environmental factors
#define LIGHT_COL_DATA_BLOCK0 endLightCol
#define SKY_COL_DATA_BLOCK endSkyCol