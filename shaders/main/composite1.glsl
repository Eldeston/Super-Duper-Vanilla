...
INOUT vec2 texcoord;
    ...
    void main(){
        ...
        float volMult = VOL_LIGHT_BRIGHTNESS * (1.0 - newTwilight) * (1.0 - blindness * 0.6) * (0.25 * (1.0 - eyeBrightFact) + eyeBrightFact) * min(1.0, FOG_OPACITY + rainMult * underWaterMult * 0.125);
