...
INOUT mat3 TBN;
    ...
    void main(){
        ...
        float metallic = (entity.x >= 10008 && entity.x <= 10010) || entity.x == 10015 ? 0.75 : 0.0;
        float ss = (entity.x >= 10001 && entity.x <= 10004) || entity.x == 10007 || entity.x == 10011 || entity.x == 10013 ? sqrt(maxCol) * 0.8 : 0.0;
        float emissive = entity.x == 10005 || entity.x == 10006 ? maxCol
            : entity.x == 10014 ? satCol : 0.0;
        float roughness = (entity.x >= 10008 && entity.x <= 10010) || entity.x == 10015 ? 0.2 * maxCol : 1.0;
    ...
    /* DRAWBUFFERS:01234 */
        ...
        gl_FragData[2] = vec4(nLmCoord, ss, 1); //colortex2
        gl_FragData[3] = vec4(metallic, emissive, roughness, 1); //colortex3
        gl_FragData[4] = vec4(1, 0, color.a, 1); //colortex4
    }
#endif